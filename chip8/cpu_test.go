...
func TestADD_v_byte(t *testing.T) {
	t.Run("random state", func(t *testing.T) {
		...
		for i := 0; i < n_tests; i++ {
			...
			t.Run(fmt.Sprintf("ADD_v_byte %04X", opcode), func(t *testing.T) {
				err := opcodeTest{
					inputCpuState: inputCpuState,
					wantCpuState:  wantCpuState,
					wantError:     false,
...
func TestLD_v1_v2(t *testing.T) {
	t.Run("random state", func(t *testing.T) {
		...
		for i := 0; i < n_tests; i++ {
			...
			wantCpuState.V[r1] = inputCpuState.V[r2]
			wantCpuState.PC = inputCpuState.PC + 2

			t.Run(fmt.Sprintf("LD_v1_v2 %04X", opcode), func(t *testing.T) {
				err := opcodeTest{
					inputCpuState: inputCpuState,
					wantCpuState:  wantCpuState,
					wantError:     false,
...
func TestAND_v1_v2(t *testing.T) {
	t.Run("random state", func(t *testing.T) {
		const n_tests = 200
...
func TestXOR_v1_v2(t *testing.T) {
	t.Run("random state", func(t *testing.T) {
		const n_tests = 200
		...
		for i := 0; i < n_tests; i++ {
			...
			t.Run(fmt.Sprintf("XOR_v1_v2 %04X", opcode), func(t *testing.T) {
				err := opcodeTest{
					inputCpuState: inputCpuState,
					wantCpuState:  wantCpuState,
					wantError:     false,
